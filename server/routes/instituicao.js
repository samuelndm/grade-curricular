...
router.patch('/:id', async (req, res) => {
  ...
  try {
    ...
    if (req.body.nome != null) { instituicao.nome = req.body.nome }

    if (req.body.idLogo != null) { instituicao.idLogo = req.body.idLogo }

    if (req.body.campus != null) { instituicao.campus = req.body.campus }

    if (req.body.cursos != null) { instituicao.cursos = req.body.cursos }
